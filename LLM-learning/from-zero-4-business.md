...
⭐️65.6k
![image28.png](./images/media/image31.png)
...
```
[代码地址](https://github.com/jiangpingT/Scratch/tree/main/Transformer)
...
* 参数更新：
    ...
    [外网访问链接：Deepseek 生成链接](https://jiangpingt.github.io/Scratch/LLM-learning/html/llm.html)
    
    [外网访问链接：genspark 生成链接](https://page.genspark.site/page/toolu_018WReAfFtdfFLUUthkUX1Gv/neural_network_visualization.html)

    [外网访问链接：manus 生成链接](https://bvgzrakh.manus.space/)
